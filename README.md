...
| **`ANTIGRAVITY_TOOL_BLOCK_RETRIES`** | `1` | Retries of a tool-blocked run on the same profile with a reinforced no-tools notice. `0` disables. Skipped once text has been streamed. |
